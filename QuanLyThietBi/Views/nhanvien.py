...
def create_nhanvien(request):
    ...
    try:
        ...
        result = NhanVienController.create_nhanvien(ten_nhan_vien, email, so_dien_thoai, role, ma_phong_ban)
...
def update_nhanvien(request, ma_nhan_vien):
    ...
    try:
        ...
        result = NhanVienController.update_nhanvien(ma_nhan_vien, ten_nhan_vien, email, so_dien_thoai, role, ma_phong_ban)
